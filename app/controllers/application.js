      ...
      nodes: [
        {
          ...
          link: null,
          caption: i18n.t('forms.application.sitemap.mu2.caption'),
          title: i18n.t('forms.application.sitemap.mu2.title'),
          children: [{
            link: 'i-i-s-mu2-k1-l',
            caption: i18n.t('forms.application.sitemap.mu2.i-i-s-mu2-k1-l.caption'),
            title: i18n.t('forms.application.sitemap.mu2.i-i-s-mu2-k1-l.title'),
            children: null
          }]
        }
      ]
